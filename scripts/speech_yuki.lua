...
return {
	...
	ANNOUNCE_DEERCLOPS = "Deerclopyyy! My bad friend will come ... to play",
	...
	ANNOUNCE_EAT =
	{
		...
		YUCKY = "No no no~ I am a vegetarian",
	},
	...
	ANNOUNCE_HOUNDS = "Stupid dogs! They are comming!",
	ANNOUNCE_WORMS = "Did you feel that?",
	ANNOUNCE_HUNGRY = ".... At time to feed :(",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Come out Come out! Where ever you are~",
	ANNOUNCE_HUNT_LOST_TRAIL = "Godless you!",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Let's say Thanks the rain. Hmm!",
	...
	ANNOUNCE_WORMHOLE = "It's so dirty!",
	...
	ANNOUNCE_WET = "I love water!",
	ANNOUNCE_WETTER = "Rainy Rainy~ Heavy rainy~ ",
	ANNOUNCE_SOAKED = "It's fun! Xixi~",
	...
	BATTLECRY =
	{
		GENERIC = "I'm just a tiny mushroom, forgive me!",
		PIG = "Sorry Piggy!",
		PREY = "Too small to die!",
		SPIDER = "You're Black and I'm White",
		SPIDER_WARRIOR = "I will cut your legs!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "See you later~",
		PIG = "I'll let you go Piggy.",
		PREY = "Run away baby~",
		SPIDER = "Their smell is not good",
		SPIDER_WARRIOR = "I will cut your legs later. Hmm!",
	},
	DESCRIBE =
	{
		...
		{
			BROKEN = "Poor Bernie! :(",
			GENERIC = "A cute Teddy!",
		},
		BERNIE_ACTIVE = "He's wake up!",
		...
		BLUE_CAP = "With a Red can make Pupe Mushroom",
		...
		RABBITHOLE = 
		{
			GENERIC = "Hello! Mr.Rabbit!",
			SPRING = "They are sleeping!",
		},
		RAINOMETER = 
		{	
		...
		RED_CAP = "With a Blue can make Pupe Mushroom ",
		RED_CAP_COOKED = "It's different now...",
		RED_MUSHROOM =
		{
			GENERIC = "It's a poison mushroom.",
			INGROUND = "It's sleeping.",
			PICKED = "I wonder if it will come back?",
		},
		REEDS =
